<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Coach_delete.aspx.cs" Inherits="Coach_Coach_delete" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Button ID="Button2" runat="server" Text="取消" Width="75px" PostBackUrl="~/Coach/Coach_info.aspx" />
        </div>
    </form>
</body>
</html>
