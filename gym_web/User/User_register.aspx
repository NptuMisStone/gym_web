<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_register.aspx.cs" Inherits="User_User_register" %>
        ...
        <div class="main">
            ...
            <div class="signup">
                <div style="max-height: 500px; overflow-y: auto; padding-bottom: 10px;" class="custom-scrollbar">
                    <label for="chk" aria-hidden="true">會員註冊</label>
                    <asp:Label ID="Label2" runat="server" Text="請輸入暱稱" ForeColor="White" Style="margin-left: 70px;" Font-Bold="True"></asp:Label>
                    <asp:Label ID="Label7" runat="server" Text="*(必填)" ForeColor="red" Font-Bold="True"></asp:Label>
                    <asp:TextBox ID="tb_user_name" required="required" runat="server"></asp:TextBox>
                    ...
                    <asp:TextBox ID="tb_user_acc" required="required" runat="server"></asp:TextBox>
                    ...
                    <asp:TextBox ID="tb_user_pwd" required="required" runat="server" TextMode="Password" ControlToCompare="tb_user_pwd" CausesValidation="True"></asp:TextBox>
                    ...
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="*密碼不一致~" ControlToCompare="tb_user_pwd" ControlToValidate="tb_user_pwd2" ForeColor="Red" SetFocusOnError="True"></asp:CompareValidator>
                    <asp:TextBox ID="tb_user_pwd2" required="required" runat="server" TextMode="Password"></asp:TextBox>
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" Style="margin-left: 140px;" NavigateUrl="~/User/User_login.aspx" ForeColor="White">返回登入頁面</asp:HyperLink>
