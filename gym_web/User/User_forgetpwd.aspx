<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_forgetpwd.aspx.cs" Inherits="User_User_forgetpwd" %>
            ...
            <asp:Panel ID="Panel1" runat="server" Visible="true">
                <div class="signup">
                    <div class="custom-scrollbar">
                        ...
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/User/User_login.aspx" ForeColor="White">返回登入頁面</asp:HyperLink>
                    </div>
                </div>
            </asp:Panel>
            ...
            <asp:Panel ID="Panel3" runat="server" Visible="false">
                <div class="signup">
                    <div class="custom-scrollbar">
                        ...
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="密碼不一致" ControlToCompare="tb_new_pwd" ControlToValidate="tb_new_pwd2" ForeColor="Red" Display="Dynamic"></asp:CompareValidator>
                        ...
                        <asp:Button ID="Btn_step3" runat="server" Text="確認" CssClass="btn" OnClick="Btn_step3_Click" />
                    </div>
                </div>
            </asp:Panel>
        </div>
