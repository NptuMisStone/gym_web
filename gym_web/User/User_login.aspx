        ...
        <div class="main">
            ...
            <div class="signup">
                <div>
                    ...
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/User/User_forgetpwd.aspx" ForeColor="White" Style="margin-left: 150px;">忘記密碼?</asp:HyperLink><br />

                    <asp:Label ID="Label1" runat="server" Text="沒有帳號嗎?" ForeColor="White" Style="margin-left: 90px;"></asp:Label>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/User/User_register.aspx" ForeColor="White">立即註冊會員帳號</asp:HyperLink>
                    <asp:Label ID="Label2" runat="server" Text="切換為教練：" ForeColor="White" Style="margin-left: 90px;"></asp:Label>
                    <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/Coach/Coach_login.aspx" ForeColor="White">立即切換</asp:HyperLink>
                </div>
            </div>
        </div>
    </form>
