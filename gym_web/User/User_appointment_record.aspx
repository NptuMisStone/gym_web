         ...
         <center>
                    <table style="width: 400px;">
                        <tr>
                            ...
                            <td style="text-align:right;">
                                <div style="width: 15px; height:15px; background-color: #E5B76A"></div>
                            </td>
                            <td style="text-align:left;">
                                <asp:Label ID="Label3" runat="server" Text="教練取消"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </center>
        <div class="row g-4 justify-content-center">
            <div class="text-center p-4">
                ...
                <asp:DropDownList ID="ddl_status" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddl_status_SelectedIndexChanged" >
                    ...
                    <asp:ListItem Value="5">教練取消</asp:ListItem>
                </asp:DropDownList>
                <br />
